    ...
    <>
      <div className="mt-6">
        ...
        <input
          ...
          required
          className="w-full px-4 py-2 text-zinc-800 bg-white border border-gray-300 rounded-md focus:ring focus:ring-zinc-800 focus:border-zinc-800 outline-none transition-all duration-200 placeholder-zinc-600 text-sm sm:text-base"
        />
      </div>
      ...
      <div className="mt-6">
        ...
        <input
          ...
          min="0"
          step="1"
          className="w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:ring focus:ring-zinc-800 focus:border-zinc-800 outline-none transition-all duration-200 hover:border-gray-400 text-sm sm:text-base"
        />
      </div>
      <div className="mt-6">
        <label
      ...
      <div className="mt-6 flex items-center gap-2 sm:gap-3">
        <input
          ...
          id="bestseller"
          name="bestseller"
          className="w-5 h-5 sm:w-5 sm:h-5 text-zinc-800 border-gray-300 rounded focus:ring-offset-2 cursor-pointer transition-all duration-200"
        />
        <label
          htmlFor="bestseller"
